...
public class MyTripInfoActivity extends AppCompatActivity implements TravelmateSnackbars {
    ...
    private void getSingleTrip() {
        ...
        String uri = MAIN_API_LINK + "get-trip/" + mTrip.getId();
    ...
    private void getCity(String cityname) {
        // to fetch city names
        String uri = MAIN_API_LINK + "get-city-by-name/" + cityname;
        Log.v("EXECUTING", uri);
        ...
        builder.setMessage(R.string.remove_trip_message)
                .setPositiveButton(R.string.positive_button,
                        (dialog, which) -> {
                            ...
                            String uri;
                            uri = MAIN_API_LINK + "remove-user-from-trip/" + mTrip.getId();
                            Log.v("EXECUTING", uri);
    ...
    private void friendAutoComplete() {
        ...
        String uri = MAIN_API_LINK + "get-user/" + mNameYet.trim();
        Log.v("EXECUTING", uri);
    ...
    private void addFriend() {
        ...
        String uri = MAIN_API_LINK + "add-friend-to-trip/" + mTrip.getId() + "/" + mFriendId;
    ...
    private void updateTripName() {
        ...
        String uri = MAIN_API_LINK + "update-trip-name/" + mTrip.getId() + "/" + editedTripName;
