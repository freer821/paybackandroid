...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener, LoginView, TravelmateSnackbars {
    ...
    @BindView(R.id.input_fullname_signup)
    EditText fullname_signup;
    @BindView(R.id.input_address_signup)
    EditText address_signup;
    @BindView(R.id.input_telephone_signup)
    EditText telephone_signup;
    @BindView(R.id.input_passport_signup)
    EditText passport_signup;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.ok_signup:
                ...
                String telphone = telephone_signup.getText().toString();
                String address = address_signup.getText().toString();
                String passport = passport_signup.getText().toString();
                if (validateEmail(emailString)) {
                    if (validatePassword(passString)) {
                        if (passString.equals(confirmPassString)) {
                            mLoginPresenter.ok_signUp(fullname, telphone, address,
                                    passport, emailString, passString, mHandler);
                        } else {
