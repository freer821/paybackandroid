...
import io.github.project_travel_mate.utilities.BarcodeFragment;
...
import static utils.Constants.USER_ADDRESS;
...
import static utils.Constants.USER_PASSPORT;
import static utils.Constants.USER_ROLE;
import static utils.Constants.USER_TEL;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPreviousMenuItemId = R.id.nav_qrcode; // This is default item
    ...
    private void getProfileInfo() {
        ...
        String uri = MAIN_API_LINK + "user/profile";
        Log.v("EXECUTING", uri);
            ...
            public void onResponse(Call call, final Response response) throws IOException {
                ...
                mHandler.post(() -> {
                    try {
                        ...
                        JSONObject object = resObject.getJSONObject("msg");
                        String userFullName = object.getString("full_name");
                        String userTel = object.getString("tel");
                        String userAddress = object.getString("address");
                        String userPassport = object.getString("passport");
                        String userRole = object.getString("passport");
                        ...
                        mSharedPreferences.edit().putString(USER_ADDRESS, userAddress).apply();
    ...
    protected void onResume() {
        super.onResume();
        fillNavigationView(mSharedPreferences.getString(USER_FULL_NAME, getString(R.string.app_name)),
    ...
    public void updateNotificationsCount(Menu menu) {
        String uri;
        uri = MAIN_API_LINK + "number-of-unread-notifications";
        Log.v("EXECUTING", uri);
